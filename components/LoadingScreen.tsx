    ...
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-[#fdfcff] dark:bg-[#030712] transition-opacity duration-500">
      <div className="relative w-32 h-32 flex items-center justify-center mb-8">
        ...
        <div className="absolute bottom-2 left-2 animate-float z-10">
          <Cloud
            size={64}
            className="text-[#4c8df6] dark:text-[#6fa4f8] drop-shadow-xl fill-white dark:fill-gray-900"
            strokeWidth={1.5}
          />
        </div>
      </div>
      ...
      <div className="text-center space-y-2 animate-slide-up">
        <h1 className="text-3xl font-bold text-[#1f1f1f] dark:text-gray-100 tracking-tight font-sans">
          SkyYou
        </h1>
        {status && (
          <p className="text-sm font-medium text-gray-400 dark:text-gray-500 uppercase tracking-widest">
            {status}
          </p>
        )}
      </div>
